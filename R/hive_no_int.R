...
#'
#' @export
hive_no_int <- function(nodes, links, innerRadius=40, outerRadius = 240, opacity=0.7, width = NULL, height = NULL, elementId = NULL) {
...
hiveOutput <- function(outputId, width = '100%', height = '400px'){
  htmlwidgets::shinyWidgetOutput(outputId, 'hive_no_int', width, height, package = 'hiveD3')
}
